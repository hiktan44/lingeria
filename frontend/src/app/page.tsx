        ...
        <div className="max-w-7xl mx-auto relative z-10 grid lg:grid-cols-2 gap-12 items-center">
          <div className="flex flex-col items-start text-left">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-purple-500/10 border border-purple-500/20 text-purple-300 text-xs font-semibold mb-6">
              ...
              <span>Yeni Nesil Yapay Zeka Stüdyosu v2.0</span>
            </div>
            <h1 className="text-5xl lg:text-7xl font-extrabold tracking-tight mb-6 leading-[1.1]">
              Geleceğin Moda <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-500">
                Stüdyosuna Hoş Geldiniz
              </span>
            </h1>
            <p className="text-gray-400 text-lg lg:text-xl mb-10 max-w-xl leading-relaxed">
              Fiziksel numunelerinizi saniyeler içinde büyüleyici 
              e-ticaret görsellerine dönüştürün. Manken, mekan veya prodüksiyon 
              maliyeti olmadan yaratıcılığınızı özgür bırakın.
            </p>
      ...
      <section id="features" className="py-24 bg-[#050505] border-t border-white/5">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-3xl lg:text-4xl font-bold mb-4">Sınırları Kaldıran Özellikler</h2>
            <p className="text-gray-400 max-w-2xl mx-auto">
              Geleneksel fotoğraf çekimlerinin karmaşasını unutun. Fasheone AI ile tüm kontrol elinizde.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            <FeatureCard 
              ...
              title="Gelişmiş Model Senaryoları"
              desc="Nano Banana Pro ve SeedDream 5.0 gibi endüstri lideri AI modelleri ile en yüksek fotorealistik kaliteyi elde edin."
            />
            <FeatureCard 
              ...
              title="Manken Özelleştirme"
              desc="Yaş, vücut tipi, saç rengi ve boy uzunluğu gibi parametreleri saniyeler içinde değiştirerek hedeflenen kitleye uygun görseller üretin."
            />
            <FeatureCard 
              ...
              title="Işık ve Mekan Kontrolü"
              desc="Stüdyo aydınlatması, dış mekan veya gece çekimi gibi profesyonel aydınlatma kurulumlarını tek tıkla uygulayın."
            />
          </div>
        </div>
      </section>
